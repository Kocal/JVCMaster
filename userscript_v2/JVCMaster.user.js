...
window.JVCMaster_sVersion = "2.4.9"
    ...
    this.oScripts.citation = {
        ...
        main : function(){
            ...
            vars.oPosts.each(function(){
                ...
                html = html.replace(/((Ecrit par|Citation de) (?:« )?(.*[^»])(?: »)?)/g, "<div class='JVCMaster_citation_viewOnTopic' style='padding: 23px 5px 5px;background: #D3EFFF;border: 1px solid #51BFFF;border-radius: 6px;margin: 5px 0;position: relative;'>$1");
                html = html.replace(/ »\n(?: <br>(\| )*\n){1,2} <br>(\| )*(?:&gt;)?/g, "</div>");
